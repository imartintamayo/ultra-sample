...
export class Game {
    ...
    @ApiProperty({ example: "some release date", description: 'The release date of the Game' })
    releaseDate: Date;

    @ApiProperty({ example: ["tag1", "tag2"], description: 'The tags of the Game' })
    tags?: string[] = [];

    @ApiProperty({ example: { name: "some name", siret: 1234, phone: "some phone" }, description: 'The publisher of the Game' })
    publisher: Publisher;
}